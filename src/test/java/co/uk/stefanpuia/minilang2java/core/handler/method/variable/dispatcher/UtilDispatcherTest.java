...
class UtilDispatcherTest {
  @Mock private SimpleMethod method;

  @Test
  void shouldConvert() {
    final UtilDispatcher dispatcher = new UtilDispatcher(conversionContext(), method);
    then(dispatcher.getConverted()).isEqualTo("final LocalDispatcher dispatcher");
  }
}
