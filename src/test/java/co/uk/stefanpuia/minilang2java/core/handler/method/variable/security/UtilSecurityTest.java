...
class UtilSecurityTest {
  @Mock private SimpleMethod method;

  @Test
  void shouldConvert() {
    final UtilSecurity security = new UtilSecurity(conversionContext(), method);
    then(security.getConverted()).isEqualTo("final Security security");
  }
}
