...
@MinilangTag("if-not-empty")
public class IfNotEmpty extends ConditionalTag implements IfOp {

  private final Attributes attributes;

  public IfNotEmpty(final TagInit tagInit) {
    super(tagInit);
  ...
  public String convertCondition() {
    ...
    return format("UtilValidate.isNotEmpty(%s)", attributes.getField().makeGetter());
  }
